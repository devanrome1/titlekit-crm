...
class TransStrings
{
    ...
    public static function getStrings()
    {
        return [
            ...
            'activity_log_info'                                                                      => __('Enable to log TitleKit CRM activity events. Useful for tracking purpose.', 'fluent-crm'),
            'activity_log_info_2'                                                                    => __('Logs for TitleKit CRM activity events. Useful for tracking purpose.', 'fluent-crm'),
            'Add'                                                                                    => __('Add', 'fluent-crm'),
            ...
            'Addons.Recommended.Plugins.desc'                                                        => __('Extend TitleKit CRM functionalities and supercharge your email marketing and automation', 'fluent-crm'),
            'Addons.fluentcrm_pro.title'                                                             => __('Supercharge your Email Marketing and Automation with TitleKit CRM Pro', 'fluent-crm'),
            ...
            'Assigned List in FluentCRM (optional)'                                                  => __('Assigned List in TitleKit CRM (optional)', 'fluent-crm'),
            'Associate FluentCRM Manager (Non-Admin Only)'                                           => __('Associate TitleKit CRM Manager (Non-Admin Only)', 'fluent-crm'),
            ...
            'Automation_Sync_Note_5'                                                                 => __('You need to have TitleKit CRM Pro to use this feature', 'fluent-crm'),
            ...
            'Company_Logo_Auto_Download_Note'                                                        => __('If you enable this, TitleKit CRM will try to fetch the company logo automatically from the given website url.', 'fluent-crm'),
            ...
            'Edi_If_ysatrtFstettt'                                                                   => __('If you select a time range then TitleKit CRM schedule the email to that time range', 'fluent-crm'),
            ...
            'FluentCRM Field'                                                                        => __('TitleKit CRM Field', 'fluent-crm'),
            'FluentCRM_License.desc'                                                                 => __('Please Provide a license key of TitleKit CRM - Email Marketing Addon', 'fluent-crm'),
            ...
            'Fluent_CRM_Exp'                                                                         => __('Adds the new TitleKit CRM navigation experience to the dashboard', 'fluent-crm'),
            'Fluent_CRM_Nav_Hide'                                                                    => __('If you enable this, then TitleKit CRM will hide the default WP Admin Sidebar and Replace with TitleKit CRM\'s own navigation for better focus.', 'fluent-crm'),
            'Fluent_CRM_Pro_Alert'                                                                   => __('Get more related contact info with TitleKit CRM Pro. You can get more info about the contact like their purchase history, membership, course info and more.', 'fluent-crm'),
            ...
            'Get FluentCRM Email Pro'                                                                => __('Get TitleKit CRM Email Pro', 'fluent-crm'),
            'Get FluentCRM Pro'                                                                      => __('Get TitleKit CRM Pro', 'fluent-crm'),
            'Get FluentCRM Pro Now'                                                                  => __('Get TitleKit CRM Pro Now', 'fluent-crm'),
            ...
            'Get_Advance_Report_Desc'                                                                => __('Advanced Report is available on Premium Version of TitleKit CRM along wth lots of integrations, advanced automation, sequence emails and more', 'fluent-crm'),
            ...
            'Get_Improved_Help'                                                                      => __('Get improved features and faster fixes by sharing non-sensitive data via usage tracking that shows us
                how TitleKit CRM is used. No personal data is tracked or stored.', 'fluent-crm'),
            ...
            'Help us to make FluentCRM better'                                                       => __('Help us to make TitleKit CRM better', 'fluent-crm'),
            ...
            'IntegrationSettings.woo_desc'                                                           => __('Collect and segment email contacts from wooCommerce checkout and send emails. Run funnels, segment your customers into TitleKit CRM', 'fluent-crm'),
            ...
            'Lin_This_iapfPdtFPta'                                                                   => __('This is a premium feature. Please download the TitleKit CRM Pro to activate this feature.', 'fluent-crm'),
            ...
            'Please update FluentCRM Pro first'                                                      => __('Please update TitleKit CRM Pro first', 'fluent-crm'),
            ...
            'Require FluentCRM Pro'                                                                  => __('Require TitleKit CRM Pro', 'fluent-crm'),
            'Resend'                                                                                 => __('Resend', 'fluent-crm'),
            'Resend Any Emails'                                                                      => __('Resend Any Emails', 'fluent-crm'),
            'Reset FluentCRM Database tables'                                                        => __('Reset TitleKit CRM Database tables', 'fluent-crm'),
            'Rest API Status'                                                                        => __('Rest API Status', 'fluent-crm'),
            'RestApi.Please_Create_A_Manager'                                                        => __('Looks like you did not have any additional Manager yet. Please create a manager (non administrator role) first for TitleKit CRM', 'fluent-crm'),
            ...
            'Setup.FluentCrm.Share_Essentials.desc'                                                  => __('Allow TitleKit CRM to collect non-sensitive diagnostic data and usage information.', 'fluent-crm'),
            'Setup.Install_FluentForm'                                                               => __('Install Fluent Forms Plugin for Lead collections Forms.', 'fluent-crm'),
            'Setup.Send_Marketing_tips'                                                              => __('We will send marketing tips and advanced usage of TitleKit CRM (Monthly)', 'fluent-crm'),
            'Setup.Subscribe_Newsletter'                                                             => __('You can subscribe to our bi-monthly newsletter where we will email you all about TitleKit CRM.', 'fluent-crm'),
            ...
            'SmtpSettings.Configured.title'                                                          => __('Your WordPress & TitleKit CRM is set to send using FluentSMTP Plugin', 'fluent-crm'),
            ...
            'Template_Export_Alert'                                                                  => __('Template export is only available on pro version of TitleKit CRM', 'fluent-crm'),
            ...
            'This feature only available on FluentCRM Pro.'                                          => __('This feature only available on TitleKit CRM Pro.', 'fluent-crm'),
            ...
            'To'                                                                                     => __('To', 'fluent-crm'),
            'To use this feature you need FluentCRM Pro.'                                            => __('To use this feature you need TitleKit CRM Pro.', 'fluent-crm'),
            ...
            'Upgrade to FluentCRM Pro'                                                               => __('Upgrade to TitleKit CRM Pro', 'fluent-crm'),
            ...
            'Warning default email change'                                                           => __('Are you sure? All of the TitleKit CRM email will be sent from ', 'fluent-crm'),
            ...
            'Welcome to FluentCRM!'                                                                  => __('Welcome to TitleKit CRM!', 'fluent-crm'),
            ...
            'all_admin_managers_vue'                                                                 => __('All Administrators automatically will get full access of TitleKit CRM', 'fluent-crm'),
            'and manage subscription/unsubscribe url is mandatory'                                   => __('and manage subscription/unsubscribe url is mandatory', 'fluent-crm'),
            'associate data with FluentCRM'                                                          => __('associate data with TitleKit CRM', 'fluent-crm'),
            'at'                                                                                     => __('at', 'fluent-crm'),
            ...
            'create_dynamic_segments_of_contacts_introduction'                                       => __('Create dynamic Segments of contacts by using dynamic contact properties and filter your target audience. Available in pro version of TitleKit CRM', 'fluent-crm'),
            ...
            'crm_managers_roles_and_permissions'                                                     => __('Add More Users to your TitleKit CRM and give them selected permissions to manage your marketing. For example, You can add user X to view only the reports and User Y to manage only email campaigns.', 'fluent-crm'),
            ...
            'fluentcrtm_integrations_with_all_of_plugins'                                            => __('TitleKit CRM has integrations with all of your favorite plugins. This settings will be available based on your plugin installed. These integrations are only available on the', 'fluent-crm'),
            'fluentform_info'                                                                        => __('Fluent Forms is fast and very light-weight and works perfectly with TitleKit CRM.', 'fluent-crm'),
            ...
            'importing_funnel_from_json_file'                                                        => __('Importing Funnel from JSON file is a pro feature. Please download and active TitleKit CRM Pro First', 'fluent-crm'),
            ...
            'learn_about_fluentSMTP'                                                                 => __('For TitleKit CRM users, we built a well-optimized SMTP/Amazon SES plugin. It will help you manage all your WordPress website emails, including TitleKit CRM emails.', 'fluent-crm'),
            ...
            'pro version of FluentCRM'                                                               => __('pro version of TitleKit CRM', 'fluent-crm'),
            'processing'                                                                             => __('processing', 'fluent-crm'),
            'published'                                                                              => __('published', 'fluent-crm'),
            'published within'                                                                       => __('published within', 'fluent-crm'),
            'quick_links.ff_desc'                                                                    => __('Fluent Forms is a free form plugin for WordPress that is integrated with TitleKit CRM', 'fluent-crm'),
            ...
            'reset_db_warning'                                                                       => __('All Your TitleKit CRM Data (Contacts, Campaigns, Settings, Emails) will be deleted', 'fluent-crm'),
            ...
            'thankyou_for_using_fluentcrm'                                                           => __('Thank you for choosing TitleKit CRM. An easier way to manage email marketing campaigns! This quick setup wizard will help you configure the basic settings.', 'fluent-crm'),
            ...
            'total'                                                                                  => __('total', 'fluent-crm'),
            'transfer_data_from_current_ems_to_fluentcrm'                                            => __('Transfer your contacts, tags and associate data from your current email marketing software to TitleKit CRM in minutes', 'fluent-crm'),
            ...
            'will be created automatically in FluentCRM'                                             => __('will be created automatically in TitleKit CRM', 'fluent-crm'),
            ...
            'with_fluentcrm_pro_integrate_with_other_plugins'                                        => __('With TitleKit CRM Pro, you can integrate with other plugins like E-commerce, Membership, LMS (25+ integrations) along with advanced reports, sequence (drip) emails, advanced automation and unlock lots of useful features.', 'fluent-crm'),
            ...
            'Recurring_Campaign_Export_Alert'                                                        => __('Recurring Campaign export is only available on pro version of TitleKit CRM', 'fluent-crm'),
            'Campaign_Export_Alert'                                                        => __('Campaign export is only available on pro version of TitleKit CRM', 'fluent-crm'),
            ...
            'Exporting_archived_campaign_Emails_alert'                                              => __('Exporting archived campaign emails is only available in the Pro version of TitleKit CRM', 'fluent-crm'),
            ...
            'Coupon_Code_Prefix_help'                                                               => sprintf(__("TitleKit CRM will generate a random coupon code for each contact. Use a prefix to make something like '%s'.", 'fluent-crm'), 'YOUR_PREFIX-XYZHS4'),
            ...
            'Status for your new contacts who are not exist in FluentCRM Database'                  => __('Status for your new contacts who are not exist in TitleKit CRM Database', 'fluent-crm'),
